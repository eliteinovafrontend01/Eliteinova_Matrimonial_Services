// src/components/admin/vendors/categories/BridalMakeupPage.jsx
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead><tr className="bg-gray-50">{['Vendor ID', 'Stylist Name', 'Service Type', 'Location', 'Rating', 'Bookings', 'Status', 'Verified', 'Actions'].map(h => <th key={h} className="px-4 py-3 text-left text-[11px] font-bold text-gray-400">{h}</th>)}</tr></thead>
          <tbody>
...
export const BridalMakeupPage = () => {
  ...
  const vendors = [
    { id: 'BRI001', name: 'Glam Bridal Studio', serviceType: 'Bridal Makeup & Hair', location: 'Mumbai', rating: 4.9, bookings: 203, status: 'Active', verified: true, avatarBg: 'bg-gradient-to-br from-amber-400 to-yellow-400', tagColor: 'bg-amber-50 text-amber-700' },
    { id: 'BRI002', name: 'Groom Style Co.', serviceType: 'Groom Grooming & Styling', location: 'Delhi', rating: 4.7, bookings: 98, status: 'Active', verified: true, avatarBg: 'bg-gradient-to-br from-yellow-400 to-amber-400', tagColor: 'bg-yellow-50 text-yellow-700' },
    { id: 'BRI003', name: 'Saree Drape Masters', serviceType: 'Saree Draping & Dressing', location: 'Chennai', rating: 4.6, bookings: 71, status: 'Active', verified: true, avatarBg: 'bg-gradient-to-br from-orange-400 to-amber-400', tagColor: 'bg-orange-50 text-orange-700' },
    { id: 'BRI004', name: 'Pre-Wed Looks Studio', serviceType: 'Pre-Wedding Styling', location: 'Bangalore', rating: 4.5, bookings: 48, status: 'Pending', verified: false, avatarBg: 'bg-gradient-to-br from-pink-400 to-amber-400', tagColor: 'bg-pink-50 text-pink-700' },
  ];
  ...
  const stats = [
    { label: 'Total Stylists', value: '39', icon: '💄', color: 'border-amber-400', filter: 'All' },
    { label: 'Active', value: '31', icon: '✅', color: 'border-green-400', filter: 'Active' },
    { label: 'Pending Approval', value: '5', icon: '⏳', color: 'border-yellow-400', filter: 'Pending' },
    { label: 'Certified Artists', value: '24', icon: '🏅', color: 'border-pink-400', filter: 'Top Rated' },
  ];
  ...
  return (
    <div>
      <div className="rounded-2xl p-5 mb-6 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200">
        <div className="flex items-center gap-4"><div className="text-4xl">💄</div><div><h3 className="text-lg font-bold text-gray-800">Groom & Bridal Styling</h3><p className="text-sm text-gray-500">Bridal Makeup, Groom Styling, Hairstyling, Saree Draping & Pre-Wedding Looks</p></div></div>
      </div>
      ...
      <VendorTable vendors={filteredVendors} title="All Styling Vendors" count={`${filteredVendors.length} vendors shown`} activeFilter={activeFilter} onFilter={setActiveFilter} />
